...
$filter_audience = $_GET['audience'] ?? 'owners';
...
if ($filter_audience !== 'all') {
    if ($filter_audience === 'owners' || $filter_audience === 'all') {
        $where_conditions[] = "sn.target_audience IN (?, 'all')";
        $params[] = $filter_audience;
    }
} else {
    // Show news relevant to owners by default
...
// Get owner statistics for dashboard
...
<div class="container-fluid py-4">
        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">Stay updated with the latest news and important announcements for property owners</p>
                </div>
            ...
            <div class="card dashboard-card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0"><?php echo $stats['total_properties']; ?></h4>
        ...
        <div class="col-md-3">
            <div class="card dashboard-card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0"><?php echo count($news_articles); ?></h4>
    ...
    <?php if (empty($news_articles)): ?>
        <div class="text-center py-5">
            ...
            <p class="text-muted">Check back later for new announcements relevant to property owners.</p>
        </div>
    <?php else: ?>
        <!-- Featured News -->
